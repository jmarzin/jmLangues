...
class ThemesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mCursor = Theme.where(db!!, ThemeContract.ThemeTable.COLUMN_NAME_LANGUE_ID +
        ...
        val adapter = SimpleCursorAdapter(
            ...
            mCursor,
            arrayOf(ThemeContract.ThemeTable.COLUMN_NAME_NUMERO, ThemeContract.ThemeTable.COLUMN_NAME_LANGUE),
        ...
        listView.onItemClickListener = AdapterView.OnItemClickListener { parent, view, pos, id ->
            ...
            val rowId = mCursor.getInt(mCursor.getColumnIndexOrThrow(ThemeContract.ThemeTable.COLUMN_NAME_ID))
